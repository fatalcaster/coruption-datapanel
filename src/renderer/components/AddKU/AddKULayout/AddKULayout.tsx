...
export const AddKULayout: React.FC<AddKULayoutProps> = React.memo(
  ({ onClose, data }) => {
    ...
    const [takenItems, setItemsList] = useState<InterfaceHelpers.TakenItem[]>();
                  ...
                  <table className={styles.KUMainLeftTable}>
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <Field
                            ...
                            as={UnderlineInput}
                            notValid={
                              props.errors.ku_number && props.touched.ku_number
                            }
                          />
                          <Field
                            name="ku_file"
                      ...
                      <tr>
                        ...
                        <td>
                          <Field
                            ...
                            as={UnderlineInput}
                            notValid={
                              props.errors.case_number &&
                              props.touched.case_number
                            }
                          />
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td className={styles.al}>
                          <div className={styles.calendarContainer}>
                            <Field name="input_date" as={CalendarField} />
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td className={styles.al}>
                          <AddDamagedTable
                            damagedIndividuals={damagedIndividuals}
                            damagedLegalEntities={damagedLegalEntities}
                            setDamagedIndividuals={(new_list) =>
                              setDamagedIndividuals(new_list)
                            }
                            setDamagedLegalEntities={(new_list) =>
                              setDamagedLegalEntities(new_list)
                            }
                          />
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <CriminalActsTable
                            ...
                            suggestedCrimes={suggestedCrimes}
                      ...
                      <tr>
                        ...
                        <td>
                          <div className={styles.materialDamageDiv}>
                            <div>
                              <Field
                                name="materialDamage"
                                type="input"
                            ...
                            <Field name="euros" label="€" as={Checkbox} />
                          </div>
                        </td>
                      </tr>
                      <tr>
